...
xsetroot -name " $(print_clash)  $(print_fcitx) [ 💿 $(print_mem)M ⬆$vel_trans ⬇$vel_recv $(dwm_alsa) ] $(dwm_weather) $(print_date) "
# xsetroot -name " 💿 $(print_mem)M ⬆ $vel_trans ⬇ $vel_recv $(dwm_alsa) $(print_bat) $(dwm_weather) $(print_date) "
